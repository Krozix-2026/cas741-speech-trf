...
\begin{itemize}
  ...
  each predictor and target signal.
...
The companies or research teams that will use the software to run experiments, compare predictors, and extend the pipeline.
