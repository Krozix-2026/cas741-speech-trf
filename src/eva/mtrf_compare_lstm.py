...
# ['gammatone_8', 'gammatone_edge30_8'] superiortemporal
BASE_FILE = ROOT / f"sub-{sub_id}_ses-emptyroom_run-01_meg nobl -100-1000 50Hz superiortemporal model0 boosting h50 l2 4ptns ss1 cv.pickle"
FULL_FILE = ROOT / f"sub-{sub_id}_ses-emptyroom_run-01_meg nobl -100-1000 50Hz superiortemporal model3 boosting h50 l2 4ptns ss1 cv.pickle"

# ['gammatone_8', 'gammatone_edge30_8', 'lstm_magnitude'] aprac
# BASE_FILE = ROOT / f"sub-{sub_id}_ses-emptyroom_run-01_meg nobl -100-1000 50Hz aparc model0 boosting h50 l2 4ptns ss1 cv.pickle"
# FULL_FILE = ROOT / f"sub-{sub_id}_ses-emptyroom_run-01_meg nobl -100-1000 50Hz aparc model1 boosting h50 l2 4ptns ss1 cv.pickle"
